...
const EducationItem = ({
  ...
  return (
    ...
    >
      ...
      <div className="ml-8 p-6 bg-card shadow-elegant transition-all duration-300 ease-out transform-gpu hover:-translate-y-1 hover:scale-[1.01] hover:shadow-deep">
